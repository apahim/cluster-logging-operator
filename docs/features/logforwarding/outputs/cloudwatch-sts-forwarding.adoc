...
* The primary `roleARN` authentication still uses the ServiceAccount's AWS_ROLE_ARN environment variable
* Vector will first authenticate using the primary role, then assume the additional role
